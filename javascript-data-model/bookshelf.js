...
console.log("The author of the second book, 'JSON Quick Syntax Refernece', is: ", bookshelf[1].author);
console.log('The ISBN of the first book is: ', bookshelf[0].isbn);
console.log('The title of the third books is: ', bookshelf[2].title);
